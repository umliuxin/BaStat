    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            dropDownItemCheckbox: "dropdown-item-checkbox show", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownMenu: "action-dropdown margin-right-lg", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownMenuItems: "dropdown-content", // must be a unique class name or constellation of class names within the actionDropDown
            ...
            right: "text-right",
            search: "action-search", // must be a unique class name or constellation of class names within the header and footer
        ...
        templates: {
            ...
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"dropdown-button btn waves-effect waves-light\" type=\"button\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> <i class=\"fa fa-caret-down\"></i><ul class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></button></div>",
            actionDropDownItem: "<li class=\"text-item\"><a data-action=\"{{ctx.action}}\" class=\"{{css.dropDownItem}} {{css.dropDownItemButton}}\">{{ctx.text}}</a></li>",
            actionDropDownCheckboxItem: "<li class=\"checkbox-item\"><label class=\"{{css.dropDownItem}}\"><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /> {{ctx.label}}</label></li>",
            actions: "<div class=\"{{css.actions}}\"></div>",
            body: "<tbody></tbody>",
            cell: "<td class=\"{{ctx.css}}\" style=\"{{ctx.style}}\">{{ctx.content}}</td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col xs12 s6\"><p class=\"{{css.pagination}}\"></p></div><div class=\"col hide-on-xsmall-only s6 infoBar text-align-right\"><p class=\"{{css.infos}}\"></p></div></div></div>",
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col hide-on-xsmall-only m12 pos-relative\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-field no-margin\"><input type=\"text\" class=\"{{css.searchField}} validate\" placeholder=\"{{lbl.search}}\"/></div></div>",
